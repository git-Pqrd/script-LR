...
#
def parse(brand) :
    file_name = './precision_roller/drum_units_'+ brand + '.csv'
    result = requests.get('https://www.precisionroller.com/category/drum-units/'+brand+'.htm')
